...
public class InfoRempah : MonoBehaviour {
    [Header("---Window---")]
    ...
    private void Start() {
        ...
        restokDaganganButton.GetComponent<Button>().onClick.AddListener(RestokRempah);
        ...
        merchantData.costUpTanahLiat = 8;
        merchantData.costUpBatuAkik = 1;
        merchantData.hargaUpgrade = 625;
    }
