...
public class PlayerMovementNew : MonoBehaviour
{
    ...
    private MerchantTypeSO merchantTypeSO;
    ...
    {   
        //Tambahin
        if (Input.GetMouseButtonDown(0) && (!EventSystem.current.IsPointerOverGameObject() || merchantSelectUI.cursorInstance == null) && merchantManager.isMerchantPlaced == true)
        {
            SetTargetPosition();
            ShowClickMarker();
        }
